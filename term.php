...
<body style="">
	...
	background-color: #acba94;" class = "container-fluid">

		<div class = "panel panel-default">
			<div class = "panel-body">
<br>
			<center>	<strong><h2><u>RULES AND REGULATION</u></h2></strong></center>
				<br>
				<strong><h4 style = "color:#ff0000; margin-left:20px;">1. Tariff</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">2. Settlement of Bills</h4></strong>
				<p>Bills must be settled on presentation, personal cheques are not accepted.</p>
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">3. Company's Lien on Guest's Luggage and Belongings</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">4. Check-in</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">5. Departure</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">6. Luggage Storage</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">7. Pets</h4></strong>
				<p>Mention your policy for Pets ( allowed or not- allowed ) (Allow us to make separate arrangements. )</p>
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">8. Hazardous Goods</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">9. Damage to Property</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">10. Management's Rights</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">11. Relation between Management and Guest</h4></strong>
				...
				<br>
				<strong><h4 style = "color:#ff0000;margin-left:20px;">12. Government rules and regulations and application of laws</h4></strong>
