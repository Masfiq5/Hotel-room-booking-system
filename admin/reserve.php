				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><strong><?php if($fetch['checkin'] <= date("Y-m-d", strtotime("+0 HOURS")))
							{
							...
							<td><center>
								<a class = "btn btn-success" href = "confirm_reserve.php?transaction_id=
								<?php
								echo $fetch['transaction_id']
								?>">Check In</a>
								<a class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?transaction_id=<?php
								 echo $fetch['transaction_id']?>"> Discard</a></td>
						</tr>
						<?php
							}
						?>
